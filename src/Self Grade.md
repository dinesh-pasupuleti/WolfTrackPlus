...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------------------------------------------------|
|Video                                                                                                                                                  |3  |4min video of new functionality, showing a significant delta from prior.                                      |
...
|                                                                                                                                                       |     |                                                                                                              |
|Number of commits                                                                                                                                      |3  |    89                                                                                                      |(https://github.com/dinesh-pasupuleti/WolfTrackPlus)
...
|Use of code coverage                                                                                                                                   |3  |[config files in GH                                                                             ](https://github.com/dinesh-pasupuleti/WolfTrackPlus/actions/workflows/coverage.yml)               |
...
|Test cases are routinely executed                                                                                                                      |3  |  github actions are being used to execute the test cases every time a commit happens. </br> https://github.com/dinesh-pasupuleti/WolfTrackPlus/actions/workflows/python-tests.yml                                                                                                            |
